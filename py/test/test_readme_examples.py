# MunicipalFinance SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions MunicipalFinanceSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both MunicipalFinanceSDK(...) and MunicipalFinanceSDK.test(...) become
#      MunicipalFinanceSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "municipalfinance_sdk"
_SDK_CLASS = "MunicipalFinanceSDK"
...
_ENTITIES = {
    "AgedCreditor": "aged_creditor",
    "AgedDebtor": "aged_debtor",
    "Fact": "fact",
}
