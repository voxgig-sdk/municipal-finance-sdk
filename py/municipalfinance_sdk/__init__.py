...
from municipalfinance_sdk.utility import register

# Load features
from municipalfinance_sdk.feature.base_feature import MunicipalFinanceBaseFeature
from municipalfinance_sdk.features import _has_feature, _make_feature
...
class MunicipalFinanceSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = MunicipalFinanceUtility()
        self._utility = utility

        from municipalfinance_sdk.config import shared_config
    ...
    def get_utility(self):
        return MunicipalFinanceUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("MunicipalFinanceSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def AgedCreditor(self, data=None) -> "AgedCreditorEntity":
        ...
        from municipalfinance_sdk.entity.aged_creditor_entity import AgedCreditorEntity
    ...
    def AgedDebtor(self, data=None) -> "AgedDebtorEntity":
        ...
        from municipalfinance_sdk.entity.aged_debtor_entity import AgedDebtorEntity
        return AgedDebtorEntity(self, data)


    def Fact(self, data=None) -> "FactEntity":
        """Entity factory: client.Fact().list() / client.Fact().load({"id": ...})."""
        from municipalfinance_sdk.entity.fact_entity import FactEntity
