...
from municipalfinance_sdk.core.helpers import get_ctx_prop, to_map
...
class MunicipalFinanceContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = MunicipalFinanceControl()
        ...
        if isinstance(sp, MunicipalFinanceSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, MunicipalFinanceResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, MunicipalFinanceResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return MunicipalFinanceOperation({})
    ...
    def make_error(self, code, msg):
        return MunicipalFinanceError(code, msg, self)
