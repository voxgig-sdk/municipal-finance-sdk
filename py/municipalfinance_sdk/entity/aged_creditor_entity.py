...
from municipalfinance_sdk.municipalfinance_types import (
    AgedCreditor,
    AgedCreditorListMatch,
)
...
class AgedCreditorEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AgedCreditorEntity(self._client, opts)
    ...
    def data_get(self) -> AgedCreditor:
    ...
    def match_get(self) -> AgedCreditor:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[AgedCreditor]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.AgedCreditor().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
