...
class AgedDebtorDirectTest extends TestCase
{
    public function test_direct_list_aged_debtor(): void
    {
        $setup = aged_debtor_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-aged_debtor", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
