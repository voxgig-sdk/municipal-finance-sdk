...
class AgedCreditorDirectTest extends TestCase
{
    public function test_direct_list_aged_creditor(): void
    {
        $setup = aged_creditor_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-aged_creditor", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
