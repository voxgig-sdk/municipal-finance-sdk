...
// MunicipalFinance SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (MunicipalFinanceSDK::test)
...
{
    private const SDK_CLASS = 'MunicipalFinanceSDK';
    ...
    private const SDK_BASE = 'municipalfinance_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../municipalfinance_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
