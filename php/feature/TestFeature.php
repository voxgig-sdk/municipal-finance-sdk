...
// MunicipalFinance SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class MunicipalFinanceTestFeature extends MunicipalFinanceBaseFeature
{
    ...
    public function init(MunicipalFinanceContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (MunicipalFinanceContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = MunicipalFinanceParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (MunicipalFinanceContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(MunicipalFinanceContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = MunicipalFinanceParam::call($ctx, $k);
