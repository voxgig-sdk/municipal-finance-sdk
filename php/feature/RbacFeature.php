...
// MunicipalFinance SDK rbac feature
...
class MunicipalFinanceRbacFeature extends MunicipalFinanceBaseFeature
{
    ...
    private function _required(MunicipalFinanceContext $ctx): ?string
    {
    ...
    private function _reject(MunicipalFinanceContext $ctx, string $required): void
    {
    ...
    private function _track(MunicipalFinanceContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
