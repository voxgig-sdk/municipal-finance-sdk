...
// MunicipalFinance SDK idempotency feature
...
class MunicipalFinanceIdempotencyFeature extends MunicipalFinanceBaseFeature
{
    ...
    private function _mutating(MunicipalFinanceContext $ctx): bool
    {
