...
// MunicipalFinance SDK telemetry feature
...
class MunicipalFinanceTelemetryFeature extends MunicipalFinanceBaseFeature
{
    ...
    private function _close(MunicipalFinanceContext $ctx, bool $ok): void
    {
