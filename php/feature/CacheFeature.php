...
// MunicipalFinance SDK cache feature
...
class MunicipalFinanceCacheFeature extends MunicipalFinanceBaseFeature
{
    ...
    private function _through(MunicipalFinanceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
