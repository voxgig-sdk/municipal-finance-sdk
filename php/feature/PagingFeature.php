...
// MunicipalFinance SDK paging feature
...
class MunicipalFinancePagingFeature extends MunicipalFinanceBaseFeature
{
    ...
    private function _is_list(MunicipalFinanceContext $ctx): bool
    {
