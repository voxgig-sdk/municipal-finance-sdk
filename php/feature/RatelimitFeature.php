...
// MunicipalFinance SDK ratelimit feature
...
class MunicipalFinanceRatelimitFeature extends MunicipalFinanceBaseFeature
{
    ...
    private function _acquire(MunicipalFinanceContext $ctx): void
    {
    ...
    private function _track(MunicipalFinanceContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
