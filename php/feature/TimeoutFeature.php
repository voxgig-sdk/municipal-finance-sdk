...
// MunicipalFinance SDK timeout feature
...
class MunicipalFinanceTimeoutFeature extends MunicipalFinanceBaseFeature
{
    ...
    private function _with_timeout(MunicipalFinanceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(MunicipalFinanceContext $_ctx, float $ms): void
    {
        $client = $this->client;
