...
The PHP SDK for the MunicipalFinance API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->AgedCreditor(null)->list(null, null);
...
[$result, $err] = $client->MunicipalFinance(null)->load(
    ["id" => "test01"], null
);
