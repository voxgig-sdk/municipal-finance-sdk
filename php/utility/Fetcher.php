...
// MunicipalFinance SDK utility: fetcher

class MunicipalFinanceFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; MunicipalFinanceSDK/1.0)';
    ...
    public static function call(MunicipalFinanceContext $ctx, string $fullurl, array $fetchdef): array
    {
