...
// MunicipalFinance SDK utility: make_options

class MunicipalFinanceMakeOptions
{
    ...
    public static function call(MunicipalFinanceContext $ctx): array
    {
        ...
        //
        // `MunicipalFinanceSchema::optspec()` is built from the model:
        ...
        $optspec = MunicipalFinanceSchema::optspec();
