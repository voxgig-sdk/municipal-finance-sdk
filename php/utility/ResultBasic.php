...
// MunicipalFinance SDK utility: result_basic

class MunicipalFinanceResultBasic
{
    public static function call(MunicipalFinanceContext $ctx): ?MunicipalFinanceResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof MunicipalFinanceError) ? $result->err->msg : (string)$result->err;
