...
// MunicipalFinance SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class MunicipalFinanceTransformResponse
{
    public static function call(MunicipalFinanceContext $ctx): mixed
    {
        ...
        $transform = MunicipalFinanceHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
