...
describe("AgedCreditorEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set MUNICIPAL_FINANCE_TEST_AGED_CREDITOR_ENTID JSON to run live")
      return
    end
...
function aged_creditor_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("MUNICIPAL_FINANCE_TEST_AGED_CREDITOR_ENTID")
