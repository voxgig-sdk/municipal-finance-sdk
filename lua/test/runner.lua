...
function runner.env_override(m)
  local live = runner.getenv("MUNICIPALFINANCE_TEST_LIVE")
  local override = runner.getenv("MUNICIPALFINANCE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("MUNICIPALFINANCE_TEST_EXPLAIN")
