...
function runner.env_override(m)
  local live = runner.getenv("MUNICIPAL_FINANCE_TEST_LIVE")
  local override = runner.getenv("MUNICIPAL_FINANCE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("MUNICIPAL_FINANCE_TEST_EXPLAIN")
