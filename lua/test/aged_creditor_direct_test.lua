...
describe("AgedCreditorDirect", function()
  it("should direct-list-aged_creditor", function()
    local setup = aged_creditor_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-aged_creditor", setup.live and "live" or "unit")
...
function aged_creditor_direct_setup(mockres)
