...
describe("AgedDebtorDirect", function()
  it("should direct-list-aged_debtor", function()
    local setup = aged_debtor_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-aged_debtor", setup.live and "live" or "unit")
...
function aged_debtor_direct_setup(mockres)
