...
#      offline in seeded test mode (MunicipalFinanceSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "MunicipalFinance_sdk.rb")
  SDK_CLASS = "MunicipalFinanceSDK"
