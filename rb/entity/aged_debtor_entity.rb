...
class AgedDebtorEntity
  ...
  def make
    opts = @_entopts.dup
    AgedDebtorEntity.new(@_client, opts)
  end
  ...
  # @return [AgedDebtor, Hash] the current AgedDebtor data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of AgedDebtor fields)
  def match_get
  ...
  #
  # @param reqmatch [AgedDebtorListMatch, Hash, nil] match filter (any subset of
  #   AgedDebtor fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<AgedDebtor>, Array] the matching AgedDebtor items; raises MunicipalFinanceError on failure
