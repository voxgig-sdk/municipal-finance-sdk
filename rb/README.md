...
The Ruby SDK for the MunicipalFinance API. Provides an entity-oriented interface using idiomatic Ruby conventions.
...
result, err = client.MunicipalFinance(nil).load(
  { "id" => "test01" }, nil
)
