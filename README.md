...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/municipal-finance` | `npm install @voxgig-sdk/municipal-finance` |
| Python | `voxgig-sdk-municipal-finance` | `pip install voxgig-sdk-municipal-finance` |
| PHP | `voxgig-sdk/municipal-finance` | `composer require voxgig-sdk/municipal-finance` |
| Golang | `github.com/voxgig-sdk/municipal-finance-sdk/go` | `go get github.com/voxgig-sdk/municipal-finance-sdk/go` |
| Ruby | `voxgig-sdk-municipal-finance` | `gem install voxgig-sdk-municipal-finance` |
| Lua | `voxgig-sdk-municipal-finance` | `luarocks install voxgig-sdk-municipal-finance` |
