...
AQL-driven CLI and REPL for the MunicipalFinance SDK. Positional arguments are
...
```sh
go build -o municipal-finance-cli ./...
```
...
./municipal-finance-cli load 1 aged_creditor
./municipal-finance-cli load '{id:1}' aged_creditor
