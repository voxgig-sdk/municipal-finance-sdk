...
func registerSDKWords(r *eng.Registry, client *sdk.MunicipalFinanceSDK) {
...
func runOp(client *sdk.MunicipalFinanceSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
