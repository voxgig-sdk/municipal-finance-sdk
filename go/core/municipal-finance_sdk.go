...
type MunicipalFinanceSDK struct {
	Mode     string
...
func (sdk *MunicipalFinanceSDK) OptionsMap() map[string]any {
...
func (sdk *MunicipalFinanceSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *MunicipalFinanceSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *MunicipalFinanceSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *MunicipalFinanceSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *MunicipalFinanceSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *MunicipalFinanceSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("MunicipalFinanceSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *MunicipalFinanceSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *MunicipalFinanceSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("MunicipalFinanceSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *MunicipalFinanceSDK {
	...
	sdk := NewMunicipalFinanceSDK(sdkopts)
	sdk.Mode = "test"
