...
type AgedCreditorEntity struct {
	name    string
...
func NewAgedCreditorEntity(client *core.MunicipalFinanceSDK, entopts map[string]any) *AgedCreditorEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AgedCreditorEntity) GetName() string { return e.name }
...
func (e *AgedCreditorEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AgedCreditorEntity) Deleted() bool {
	return e.deleted
}


func (e *AgedCreditorEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAgedCreditorEntity(e.client, opts)
}

func (e *AgedCreditorEntity) Data(args ...any) any {
...
func (e *AgedCreditorEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *AgedCreditorEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AgedCreditorEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *AgedCreditorEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AgedCreditorEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AgedCreditorEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AgedCreditorEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
