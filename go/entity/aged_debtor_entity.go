...
type AgedDebtorEntity struct {
	name    string
	client  *core.MunicipalFinanceSDK
...
func NewAgedDebtorEntity(client *core.MunicipalFinanceSDK, entopts map[string]any) *AgedDebtorEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AgedDebtorEntity) GetName() string { return e.name }
...
func (e *AgedDebtorEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AgedDebtorEntity) Deleted() bool {
	return e.deleted
}


func (e *AgedDebtorEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAgedDebtorEntity(e.client, opts)
}

func (e *AgedDebtorEntity) Data(args ...any) any {
...
func (e *AgedDebtorEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an AgedDebtor; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AgedDebtorEntity) DataTyped(data ...AgedDebtor) AgedDebtor {
	if len(data) > 0 {
		return typedFrom[AgedDebtor](e.Data(asMap(data[0])))
	}
	return typedFrom[AgedDebtor](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through AgedDebtor (all fields
// optional at the wire level).
func (e *AgedDebtorEntity) MatchTyped(match ...AgedDebtor) AgedDebtor {
	if len(match) > 0 {
		return typedFrom[AgedDebtor](e.Match(asMap(match[0])))
	}
	return typedFrom[AgedDebtor](e.Match())
}
...
func (e *AgedDebtorEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AgedDebtorEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *AgedDebtorEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AgedDebtorListMatch and returns []AgedDebtor. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *AgedDebtorEntity) ListTyped(reqmatch AgedDebtorListMatch, ctrl map[string]any) ([]AgedDebtor, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[AgedDebtor](res), nil
}



func (e *AgedDebtorEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AgedDebtorEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AgedDebtorEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AgedDebtorEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
