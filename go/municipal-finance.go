...
// instead of `sdk.NewMunicipalFinanceSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *MunicipalFinanceSDK  { return NewMunicipalFinanceSDK(nil) }
func Test() *MunicipalFinanceSDK { return TestSDK(nil, nil) }
