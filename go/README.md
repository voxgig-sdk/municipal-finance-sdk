...
The Golang SDK for the MunicipalFinance API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/municipal-finance-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/municipal-finance-sdk=../path/to/github.com/voxgig-sdk/municipal-finance-sdk
```
...
```
github.com/voxgig-sdk/municipal-finance-sdk/
...
The root package (`github.com/voxgig-sdk/municipal-finance-sdk`) re-exports everything needed
