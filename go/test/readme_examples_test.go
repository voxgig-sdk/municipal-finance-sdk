...
const testSeed = `map[string]any{"entity": map[string]any{"aged_creditor": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "aged_debtor": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "fact": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
