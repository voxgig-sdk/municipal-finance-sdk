...
exports.MunicipalFinanceEntityBase = void 0;
const node_util_1 = require("node:util");
// TODO: needs Entity superclass
// `D` is the entity's typed data model (e.g. Advice); subclasses bind it via
// `class AdviceEntity extends MunicipalFinanceEntityBase<Advice>`.
class MunicipalFinanceEntityBase {
    name = '';
    name_ = '';
    Name = '';
    _client;
...
exports.MunicipalFinanceEntityBase = MunicipalFinanceEntityBase;
//# sourceMappingURL=MunicipalFinanceEntityBase.js.map