...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.MUNICIPALFINANCE_TEST_LIVE ||
    'TRUE' === process.env.MUNICIPALFINANCE_TEST_OVERRIDE
  ) {
  ...
  m.MUNICIPALFINANCE_TEST_EXPLAIN = process.env.MUNICIPALFINANCE_TEST_EXPLAIN || m.MUNICIPALFINANCE_TEST_EXPLAIN
