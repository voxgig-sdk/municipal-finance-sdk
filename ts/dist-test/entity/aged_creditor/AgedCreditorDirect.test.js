...
(0, node_test_1.describe)('AgedCreditorDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.MunicipalFinanceSDK({
    ...
    (0, node_test_1.test)('direct-list-aged_creditor', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-aged_creditor', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.MUNICIPAL_FINANCE_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.MunicipalFinanceSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['MUNICIPAL_FINANCE_TEST_AGED_CREDITOR_ENTID'];
    ...
    const client = new __1.MunicipalFinanceSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=AgedCreditorDirect.test.js.map