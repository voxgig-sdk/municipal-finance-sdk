...
(0, node_test_1.describe)('AgedDebtorDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-aged_debtor', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-aged_debtor', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'MUNICIPAL_FINANCE_TEST_AGED_DEBTOR_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['MUNICIPAL_FINANCE_TEST_AGED_DEBTOR_ENTID'];
...
//# sourceMappingURL=AgedDebtorDirect.test.js.map