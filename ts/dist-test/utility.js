...
function envOverride(m) {
    if ('TRUE' === process.env.MUNICIPAL_FINANCE_TEST_LIVE ||
        'TRUE' === process.env.MUNICIPAL_FINANCE_TEST_OVERRIDE) {
    ...
    m.MUNICIPAL_FINANCE_TEST_EXPLAIN = process.env.MUNICIPAL_FINANCE_TEST_EXPLAIN || m.MUNICIPAL_FINANCE_TEST_EXPLAIN;
    return m;
}
