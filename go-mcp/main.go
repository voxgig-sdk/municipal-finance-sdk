// Command MunicipalFinance-mcp is an MCP server exposing the MunicipalFinance
// SDK as MCP tools.
//
// Two tools are registered:
//
//	MunicipalFinance_list  — list records of an entity
//	MunicipalFinance_load  — load a single record of an entity
//
