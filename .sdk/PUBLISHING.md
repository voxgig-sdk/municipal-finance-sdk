...
|---|---|---|
| `ts/` | @voxgig-sdk/municipal-finance-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/municipal-finance-sdk \
      --repository voxgig-sdk/municipal-finance-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/municipal-finance-sdk` shows it, and
`npm trust revoke @voxgig-sdk/municipal-finance-sdk --id=<id>` removes it.
