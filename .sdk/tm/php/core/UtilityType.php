...
// MunicipalFinance SDK utility type

class MunicipalFinanceUtility
{
    ...
    public static function copy(MunicipalFinanceUtility $src): MunicipalFinanceUtility
    {
        $u = new MunicipalFinanceUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
