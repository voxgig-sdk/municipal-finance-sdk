...
// MunicipalFinance SDK proxy feature
...
class MunicipalFinanceProxyFeature extends MunicipalFinanceBaseFeature
{
    ...
    public function init(MunicipalFinanceContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (MunicipalFinanceContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
