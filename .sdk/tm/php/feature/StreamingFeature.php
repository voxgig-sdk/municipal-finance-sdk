...
// MunicipalFinance SDK streaming feature
...
class MunicipalFinanceStreamingFeature extends MunicipalFinanceBaseFeature
{
    ...
    private function _iterate(MunicipalFinanceResult $result): \Generator
    {
    ...
    private function _streamable(MunicipalFinanceContext $ctx): bool
    {
