...
// MunicipalFinance SDK audit feature
...
class MunicipalFinanceAuditFeature extends MunicipalFinanceBaseFeature
{
    ...
    private function _emit(MunicipalFinanceContext $ctx, string $outcome): void
    {
