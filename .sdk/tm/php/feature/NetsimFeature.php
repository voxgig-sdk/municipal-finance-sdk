...
// MunicipalFinance SDK netsim feature
...
class MunicipalFinanceNetsimFeature extends MunicipalFinanceBaseFeature
{
    ...
    private function _simulate(MunicipalFinanceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(MunicipalFinanceContext $ctx, array $applied): void
    {
        $client = $this->client;
