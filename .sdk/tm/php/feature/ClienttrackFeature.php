...
// MunicipalFinance SDK clienttrack feature
...
class MunicipalFinanceClienttrackFeature extends MunicipalFinanceBaseFeature
{
    ...
    public function PostConstruct(MunicipalFinanceContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'MunicipalFinance-SDK';
