...
// MunicipalFinance SDK utility: graphql
//
...
class MunicipalFinanceGraphql
{
    ...
    // equivalent.
    public static function body(MunicipalFinanceContext $ctx): mixed
    {
    ...
    public static function errors(MunicipalFinanceContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
