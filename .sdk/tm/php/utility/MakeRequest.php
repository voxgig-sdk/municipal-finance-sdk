...
// MunicipalFinance SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class MunicipalFinanceMakeRequest
{
    public static function call(MunicipalFinanceContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new MunicipalFinanceResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new MunicipalFinanceResponse($fetched);
        } else {
